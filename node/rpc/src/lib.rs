...
use shadows_runtime::{opaque::Block, AccountId, Balance, Hash, Index};
...
where
	...
	C::Api: shadows_rpc_primitives_txpool::TxPoolRuntimeApi<Block>,
	...
	P: TransactionPool<Block = Block> + 'static,
{
	...
	use shadows_rpc_txpool::{TxPool, TxPoolServer};
