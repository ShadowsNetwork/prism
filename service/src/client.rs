...
///
/// As there exist multiple chains inside Shadows, like Shadows itself, Karura,
...
/// A handle to a Shadows client instance.
///
/// The Shadows service supports multiple different runtimes (Karura, Shadows
...
/// A client instance of Shadows.
#[derive(Clone)]
pub enum Client {
	Mandala(Arc<crate::FullClient<shadows_runtime::RuntimeApi, crate::MandalaExecutor>>),
}
