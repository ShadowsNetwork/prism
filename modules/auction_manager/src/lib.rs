...
const OFFCHAIN_WORKER_DATA: &[u8] = b"shadows/auction-manager/data/";
const OFFCHAIN_WORKER_LOCK: &[u8] = b"shadows/auction-manager/lock/";
const OFFCHAIN_WORKER_MAX_ITERATIONS: &[u8] = b"shadows/auction-manager/max-iterations/";
