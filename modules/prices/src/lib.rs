...
//! process and feed prices for shadows. Process include:
...
pub trait Trait: system::Trait {
	...
	/// The fixed prices of stable currency, it should be 1 USD in shadows.
	type StableCurrencyFixedPrice: Get<Price>;

	/// The staking currency id, it should be DOT in shadows.
	type GetStakingCurrencyId: Get<CurrencyId>;

	/// The liquid currency id, it should be LDOT in shadows.
