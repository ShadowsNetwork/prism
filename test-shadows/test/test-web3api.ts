...
import {describeWithShadows, customRequest} from "./util";

describeWithShadows("Shadows RPC (Web3Api)", (context) => {

    step("should get client version", async function () {
        const version = await context.web3.eth.getNodeInfo();
        expect(version).to.be.equal("node-shadows/v1.1/fc-rpc-0.1.0");
    });
