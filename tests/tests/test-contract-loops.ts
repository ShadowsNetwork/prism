...
import { callContractFunctionMS, deployContractManualSeal, describeWithShadows } from "./util";
import {
...
describeWithShadows("Shadows RPC (Contract Loops)", `simple-specs.json`, (context) => {
