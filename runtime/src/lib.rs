...
//! The Shadows Runtime.
//!
//! This runtime powers both the shadows standalone node and the shadows parachain
...
pub struct ShadowsGasWeightMapping;

impl pallet_evm::GasWeightMapping for ShadowsGasWeightMapping {
...
impl pallet_evm::Config for Runtime {
	type FeeCalculator = ();
	type GasWeightMapping = ShadowsGasWeightMapping;
	...
	type Precompiles = precompiles::ShadowsPrecompiles<Self>;
...
parameter_types! {
	/// Shadows starts a new round every 2 minutes (20 * block_time)
...
impl_runtime_apis! {
	...
	impl shadows_rpc_primitives_txpool::TxPoolRuntimeApi<Block> for Runtime {
		fn extrinsic_filter(
